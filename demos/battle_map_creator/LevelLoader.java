...
/**
 * This class can be used to save and load levels
 * 
 * @author Ted McLeod 
 * @version 4/14/2023
 */
public class LevelLoader {
    ...
    /**
     * Loads the level in the file with the given location.
     * 
        ...
        try (Scanner fileReader = new Scanner(new File(filePath));) {
            ...
            while (fileReader.hasNextLine()) {
                ...
                if (lineReader.hasNext()) {
                    ...
                    if (lineReader.hasNextInt()) x = lineReader.nextInt();
                    else throw new ParseException("Missing x coordinate." , lineNum);
                    if (lineReader.hasNextInt()) y = lineReader.nextInt();
