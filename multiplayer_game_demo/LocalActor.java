...
public abstract class LocalActor extends GameActor {
    ...
    public void addedToWorld(World world) {
        if (getWorldOfType(GameWorld.class).getClient() != null) {
            getWorldOfType(GameWorld.class).getClient().broadcastMessage(GreenfootClient.CMD_ADD + " " + otherClass.getName() + " " + getActorId() + " " + getX() + " " + getY());
        }
    }
    ...
    public void setLocation(int x, int y) {
        ...
        if (getWorldOfType(GameWorld.class).getClient() != null) {
            getWorldOfType(GameWorld.class).getClient().broadcastMessage(GreenfootClient.CMD_MOVE + " " + getActorId() + " " + getX() + " " + getY());
        }
    }
    ...
    public void setRotation(int rotation) {
        ...
        if (getWorldOfType(GameWorld.class).getClient() != null) {
            getWorldOfType(GameWorld.class).getClient().broadcastMessage(GreenfootClient.CMD_ROTATE + " " + getActorId() + " " + getRotation());
        }
    }
    ...
    public void setImage(String fileName) {
        ...
        if (getWorldOfType(GameWorld.class).getClient() != null) {
            getWorldOfType(GameWorld.class).getClient().broadcastMessage(GreenfootClient.CMD_IMAGE + " " + getActorId() + " " + fileName);
        }
    }
