 ...
 * @version 3/24/2022
 */
public abstract class LevelWorld extends GameWorld {
    
    // The level loader for this world
    private BattleMapLoader loader;
    ...
    public LevelWorld(int level) {
        ...
        super(LevelLoader.getWorldDimensions(BattleMapLoader.getLevelPath(level)).width + leftMargin + rightMargin, // world width for the level
              LevelLoader.getWorldDimensions(BattleMapLoader.getLevelPath(level)).height + topMargin + bottomMargin, // world height for the level + HUD_HEIGHT
              1, // cell size
        ...
        loader = new BattleMapLoader(this);
     ...
     */
    public BattleMapLoader getLoader() {
        return loader;
    }
